...
class SecTspService : Service() {
     ...
     */
    fun getAvailableCommands(): Array<String> = SecTspCommandManager.getAvailableCommands()
     ...
     */
    fun sendCommand(command: String): Boolean = SecTspCommandManager.sendCommand(command)

    /**
     * Retrieves the result of the last executed command.
     * @return The command result as a string, or null if unavailable.
     */
    fun getCommandResult(): String? = SecTspCommandManager.getCommandResult()
